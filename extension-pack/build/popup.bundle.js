...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".super-center {\n  display: grid;\n  align-items: center;\n}\n\n.pop-up-container {\n  width: fit-content;\n  border-radius: 5px;\n  padding: 5px;\n}", "",{"version":3,"sources":["webpack://./src/assets/scss/app.scss"],"names":[],"mappings":"AAAA;EACE,aAAA;EACA,mBAAA;AACF;;AAEA;EACE,kBAAA;EACA,kBAAA;EACA,YAAA;AACF","sourcesContent":[".super-center {\r\n  display: grid;\r\n  align-items: center;\r\n}\r\n\r\n.pop-up-container {\r\n  width: fit-content;\r\n  border-radius: 5px;\r\n  padding: 5px;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
async function injectScript(scriptType) {
    chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
        chrome.tabs.sendMessage(tabs[0].id, scriptType);
    });
}
downloadButtonPdf.addEventListener("click", async () => {
    await injectScript({ id: _type__WEBPACK_IMPORTED_MODULE_0__.ScriptId.DOWNLOAD_PDF });
...
downloadButtonDocx.addEventListener("click", async () => {
    await injectScript({ id: _type__WEBPACK_IMPORTED_MODULE_0__.ScriptId.DOWNLOAD_WORD });
});
